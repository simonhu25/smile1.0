...
images = np.array([np.array([cv2.resize(cv2.imread(file,0),(h,w),cv2.INTER_LANCZOS4) for file in image_names])])[0]
...
clf = GridSearchCV(SVC(kernel='rbf',class_weight=None),param_grid,verbose=1)
